...
public class Mapa {
	...
	public static void main(String[] args) {
		...
		aprovados.put(1, "Pedro"); //método put serve tanto para adicionar quanto para substituir um elemento
		aprovados.put(2, "Ana");
		aprovados.put(3, "Bia");
		...
		for(Entry<Integer, String> registro2: aprovados.entrySet()) {
			System.out.println(registro2.getKey() + " " + registro2.getValue());
		}
	}
}
